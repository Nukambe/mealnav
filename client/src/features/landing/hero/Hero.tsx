  ...
  return (
    <Container className="pb-16 pt-20 text-center lg:pt-32">
      ...
      <p className="mx-auto mt-6 max-w-2xl text-lg tracking-tight text-slate-700">
        Many meal planning apps are comprehensive, but overwhelming. We choose
        simplicity, making it easy for you to eat well every day. Let's hope you
      ...
      <div className="mt-36 lg:mt-44">
        <p className="font-display text-base text-slate-900">
          Loved by families and food enthusiasts alike
        </p>
        <ul className="mt-8 flex items-center justify-center gap-x-8 sm:flex-col sm:gap-x-0 sm:gap-y-10 xl:flex-row xl:gap-x-12 xl:gap-y-0"></ul>
      </div>
    </Container>
  );
}
